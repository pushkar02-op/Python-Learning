...
#     elif (("run" in p) or ("execute" in p) or ("open" in p) or ("launch" in p)) and (
#         ("notepad" in p) or ("editor" in p)
#     ):
...
#     elif (("open" in p) or ("run" in p) or ("play" in p)) and (
#         ("player" in p) or ("media" in p)
#     ):
...
#     elif (("open" in p) or ("run" in p) or ("connect" in p) or ("launch" in p)) and (
#         "skype" in p
#     ):
...
#     elif (("open" in p) or ("run" in p) or ("launch" in p)) and (
#         ("calculator" in p) or ("calc" in p)
#     ):
